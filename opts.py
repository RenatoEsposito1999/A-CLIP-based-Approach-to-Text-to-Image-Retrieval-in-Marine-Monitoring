...
def parse_opts():
    ...
    parser.add_argument('--batch_size', default=10, type=int, help='Batch Size')#256
    ...
    parser.add_argument('--best_model_path', default="best_model.pth", help='The name of the text encoder to use as backbone')
