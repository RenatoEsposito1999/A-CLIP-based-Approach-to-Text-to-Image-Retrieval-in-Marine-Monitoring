    ...
    def turtle_create_csv(self):
        ...
        for img_name in self.img_list:
            ...
            if img_name[1] == 1: #img with dolphine
                ...
                self.writer_crop_dolphin.writerow({"image_name": f"cropped_{img_name[0]}", "comment_number": idx, "comment": sentence,"category":"dolphin"})
            ...
            if img_name[1] == 2: #img with turt == 2
                ...
                self.writer_crop_turtle.writerow({"image_name": f"cropped_{img_name[0]}", "comment_number":idx, "comment": sentence,"category":"turtle"})
            ...
            if img_name[1] == 3: ## img with trash
                ...
                self.writer_crop_debris.writerow({"image_name": f"cropped_{img_name[0]}", "comment_number":idx, "comment": sentence,"category":"debris"})
                ...
                self.writer_crop_sea.writerow({"image_name": f"cropped_{img_name[0]}", "comment_number":idx, "comment": sentence,"category":"sea"})
        '''debris_txt.close()
        sea_txt.close()
        turtle_txt.close()
        dolphine_txt.close()'''
