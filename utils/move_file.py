...
if __name__ == "__main__":
    input_dir = "/workspace/text-to-image-retrivial/NEW_DATASET/Train/COCO-Flickr30k"       # Sostituisci con la tua directory di input
    output_dir = "/workspace/text-to-image-retrivial/NEW_DATASET/Validation/COCO-Flickr30k"        # Sostituisci con la tua directory di output
    num_files = 13000                  # Numero di file da spostare
